...
export const LOGIN_TEXTS = {
  ...
  enviandoEmail: 'Enviando e-mail...',
  processando: 'Processando...',
  seuCadastroEstaCriando: 'Seu cadastro está sendo criado.',
  emailDeRecuperacaoSendoEnviado: 'E-mail de recuperação sendo enviado.',
  aguardeUmMomento: 'Aguarde um momento...',
  sistemaCalculoPontuacao: 'Sistema de Cálculo de Pontuação',
  progressaoFuncional: 'Progressão Funcional',
  recuperarSenha: 'Recuperar senha',
  cadastreSe: 'Cadastre-se',
  verifiqueSeuEmailParaContinuar: 'Verifique seu e-mail para continuar',
  verifiqueSuaCaixaDeEntradaESpam: 'Verifique sua caixa de entrada e spam.',
  cliqueNoLinkDeConfirmacaoNoEmail: 'Clique no link de confirmação no e-mail.',
  aposAConfirmacaoVocEPoderFazerLogin: 'Após a confirmação, você poderá fazer login.',
  entendiFechar: 'Entendi, fechar',
  importante: 'Importante:',
  aposCadastroVerifiqueSeuEmailParaContinuar: 'Após o cadastro, verifique seu e-mail para continuar.',
  nomeCompleto: 'Nome completo',
  joaoSilva: 'João Silva',
  emailInstitucional: 'E-mail institucional',
  seuEmailInstituicaoEduBr: 'seuemail@instituicao.edu.br',
  apenasEmailsComDominioEduSaoAceitosParaValidaçãoInstitucional: 'Apenas e-mails com domínio .edu são aceitos para validação institucional.',
  senha: 'Senha',
  matricula: 'Matrícula',
  cargo: 'Cargo',
  selecione: 'Selecione...',
  ...
  graduacao: 'Graduação',
  posGraduacaoLatoSensuEspecializacao: 'Pós-graduação lato sensu (especialização)',
  mestrado: 'Mestrado',
  doutorado: 'Doutorado',
  seuEmailExemploCom: 'seuemail@exemplo.com',
  enviarEmailDeRecuperacao: 'Enviar e-mail de recuperação',
