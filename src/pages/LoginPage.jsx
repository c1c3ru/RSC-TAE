  ...
  const handleSubmit = async (e) => {
    ...
    if (registerMode) {
      ...
      try {
        ...
        if (user) {
          setMessage(
            "Cadastro realizado com sucesso! Verifique seu login para confirmar e continuar."
          );
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Técnico de Laboratório - Biologia">
                        Técnico de Laboratório - Biologia
                      </option>
                      <option value="Técnico de Laboratório - Aquicultura">
