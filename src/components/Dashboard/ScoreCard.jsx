...
const RSCLevelBadge = ({ rsc, idx, arr, totalScore }) => (
...
const RequisitosTable = ({ totalScore, itensDistintos, nivelEscolaridade, escolaridade }) => (
...
const ScoreCard = () => {
  const { totalScore, activities } = useCompetency();
  ...
  // Ajustes visuais no JSX principal:
  return (
