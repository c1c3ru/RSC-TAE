      ...
      <div className="flex items-center justify-between px-4 py-3 min-w-0">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4 min-w-0">
          ...
          <button
            ...
            className="px-3 py-2 text-sm font-medium text-white bg-red-600 rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 transition-colors flex-shrink-0"
          >
