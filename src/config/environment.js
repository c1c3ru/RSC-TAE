...
export const getRedirectUrl = (path) => {
  ...
  const baseUrl = import.meta.env.PROD 
    ? (import.meta.env.VITE_PRODUCTION_URL || 'https://rsc-tae.vercel.app') // URL do seu site em produção
    : (import.meta.env.VITE_DEVELOPMENT_URL || 'http://localhost:5173'); // URL local atual
